...
local loginCampaignStart  = { year = 2026, month = 6, day = 2, hour = 2 }
local loginCampaignEnd    = { year = 2026, month = 9, day = 1, hour = 13 }
local loginCampaignRedeem = { year = 2026, month = 9, day = 2, hour = 13 }
